...
export default async (req) => {
  ...
  const upstream = `https://intervals.icu/api/v1/athlete/${encodeURIComponent(athleteId)}/events/bulk?upsert=${encodeURIComponent(upsert)}`;
...
export const config = {
  path: '/api/intervals/events-bulk',
};
